 ...
 ! ----------------------------------------------
 !
 ! size of static arrays per slice =   0.106812547892332       GB
 !
 !   (should be below to 80% or 90% of the memory installed per core)
 !   (if significantly more, the job will not run by lack of memory )
 !
 ! size of static arrays for all slices =    92.2860413789749       GB
 !                                      =   9.012308728415519E-002  TB
 !
